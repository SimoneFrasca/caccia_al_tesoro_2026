...
const CONFIG_LIVELLI = {
  ...
  livello6: {
    ...
    indizi: [
      "fate attenzione alla richiesta... cosa viene chiesto per prima?",
      "avete trovato il titolo dell'opera (in italiano)?",
      "bisogna inserire il titolo dell'opera"
    ],
    tempoBloccoMs: 10 * secondi,
    erroriPerIndizio: 2
  },
...
function getLivelloCorrente() {
  ...
  const mapping = {
    ...
    "6_cooperativa.html": "livello6",
    "7_cimitero.html": "livello7",
    "8_campetto.html": "livello8",
    "9_tuforustico.html": "livello9",
    ...
    "16_prova_finale.html": "livello16",
    "17_finale.html": "livello17"
  };
...
window.onload = () => {
  ...
  if (!livello) return; // Se non è una pagina mappata, esce

  const blockUntil = parseInt(localStorage.getItem(livello + "_blockUntil"));

  // Se c'è un blocco attivo nel localStorage e il tempo non è ancora scaduto
